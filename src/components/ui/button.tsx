  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        ocean: "bg-gradient-ocean text-white hover:shadow-hover transition-bounce shadow-button",
        sunset: "bg-gradient-sunset text-white hover:shadow-hover transition-bounce shadow-button",
        hero: "bg-gradient-hero text-white hover:shadow-hover transition-bounce shadow-button text-base font-semibold",
        booking: "bg-sunset text-white hover:bg-sunset-dark transition-smooth shadow-button border-0",
      },
      size: {
